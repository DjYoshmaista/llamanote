...
from config_base import OFFLOAD_DIR
...
from model_hub import ModelHub, InteractiveModelBrowser, LLAMACPP_AVAILABLE
...
Examples:
  ...
  %(prog)s doc.pdf --use-gguf path/to/model.gguf  # Use GGUF model
    ...
    model_group.add_argument(
        "--browse-models",
        action="store_true",
        help="Browse and select model interactively"
    )
    model_group.add_argument(
        "--model",
