...
describe('<ModelDialog />', () => {
    ...
    it('renders the title and help text', () => {
        ...
        expect(lastFrame()).toContain('> To use a specific Gemini model, use the --model flag.');
    });
    ...
    it('updates initialIndex when config context changes', () => {
        ...
        const { rerender } = render(_jsx(ConfigContext.Provider, { value: { getModel: mockGetModel }, children: _jsx(ModelDialog, { onClose: vi.fn() }) }));
