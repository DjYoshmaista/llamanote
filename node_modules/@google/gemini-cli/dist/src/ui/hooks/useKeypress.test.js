...
describe('useKeypress', () => {
    ...
    const renderKeypressHook = (isActive = true) => {
        ...
        return render(_jsx(KeypressProvider, { kittyProtocolEnabled: false, children: _jsx(TestComponent, {}) }));
    };
    beforeEach(() => {
        vi.clearAllMocks();
        stdin = new MockStdin();
    ...
    describe.each([
        ...
        it('should handle paste false alarm', () => {
            ...
            expect(onKeypress).toHaveBeenCalledWith(expect.objectContaining({ code: '[200d' }));
